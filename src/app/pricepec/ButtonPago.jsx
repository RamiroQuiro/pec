...
export default function ButtonPago({ priceId, promoId }) {
  ...
  return (
    <button
      ...
      className={`${
        isLoading && "bg-primary-200 animate-pulse duration-300"
      }  bg-primary-100 hover:bg-primary-200 duration-500 text-white font-bold capitalize w-full flex items-center justify-center py-3`}
    >
      {isLoading && (
        <>
          <svg
