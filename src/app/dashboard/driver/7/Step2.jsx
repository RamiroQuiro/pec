    ...
    <div className="flex items-center justify-between p-6  relative w-full  h-full">
      <div className=" flex flex-col items-baseline justify-between gap-3 h-full w-8/12">
        <h2 className="uppercase text-primary-200 text-xl">
          LO QUE TIENES QUE SABER ACERCA DE los esquemas de motivación.
        </h2>
        <p className="text-primary-200  text-xl tracking-wide leading-relaxed">
          ...
          saber acerca de los Esquemas de Motivación al Equipo Comercial.
        </p>
        ...
        <div className="flex items-center justify-normal gap-5">
          <ButtonLeerMas stepN={4}>Anterior</ButtonLeerMas>
          <ButtonLeerMas stepN={5}>Leer mas...</ButtonLeerMas>
        </div>
      </div>
