...
export default function ButtonSignOut() {
  ...
  return (
    <div
      ...
      className="flex items-center justify-normal gap-3 text-primary-textGris hover:text-primary-100 group font-semibold group cursor-pointer w-10/12 mx-auto"
    >
